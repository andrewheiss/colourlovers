structure(list(url = "http://www.colourlovers.com/api/color/408080?format=xml&", 
    status_code = 200L, headers = structure(list(date = "Sun, 28 Apr 2019 05:07:34 GMT", 
    ...
    "list")), all_headers = list(list(status = 200L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sun, 28 Apr 2019 05:07:34 GMT", 
            server = "Apache/2.2.22 (Ubuntu)", connection = "Close", 
            vary = "Accept-Encoding", `content-encoding` = "gzip", 
            `content-length` = "863", `content-type` = "text/xml; charset=utf-8"), class = c("insensitive", 
    ...
    date = structure(1556428054, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.000035, 
    connect = 0.158267, pretransfer = 0.15838, starttransfer = 0.354101, 
    total = 0.354181)), class = "response")
